...
q051 = np.percentile(T1,5)
q052 = np.percentile(T2,5)
...
sns.kdeplot(T1, label='T1', cut=0,color='b')
plt.figure(4)
sns.kdeplot(T1_2, label='T3_4',cut=0,color='y')
sns.kdeplot(T2, label='T', cut=0,color='b')
plt.legend()

cov1 = np.mean((T1_1>q051))
cov2 = np.mean((T1_2>q052))
